...
{
    [TestClass]
    public class QuandlDatasetTests
    {
        private QuandlDataset _testDataset;
        ...
        {
            _testDataset = new QuandlDataset("WIKI/FB");
        }

        [TestMethod]
        public async Task Live_DatesetGetDataOnlyTest()
        {
            DatasetDataOnlyModel testResponse = await _testDataset.GetDatasetDataOnly();
        ...
        {
            DatasetOnlyMetadataModel testResponse = await _testDataset.GetDatasetMetadataOnly();
        ...
        {
            DatasetCompleteModel testResponse = await _testDataset.GetDatasetComplete();
        ...
        {
            DatasetFilterOptions options = new DatasetFilterOptions()
            {
                Limit = 3,
            ...
            DatasetCompleteModel testResponse = await _testDataset.GetDatasetComplete(options);
        ...
        {
            DatasetSearchResult testResponse = await _testDataset.GetDatasetSearchResult(new List<string> {"us", "currency"}, "BOE");
